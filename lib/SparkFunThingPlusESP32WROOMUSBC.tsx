...
export const SparkFunThingPlusESP32WROOMUSBC_FOOTPRINT =
  "headermodule28_rows2_cols16_p2.54mm_py20.32mm_missing(1,2,3,4)_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(SparkFun Thing Plus ESP32 WROO)" as const;

export const SparkFunThingPlusESP32WROOMUSBC_PIN_LABELS = {
  pin1: ["BAT"],
  pin2: ["EN"],
  pin3: ["USB"],
  pin4: ["D13"],
...
export const SparkFunThingPlusESP32WROOMUSBC_PIN_ATTRIBUTES = {
...
export type SparkFunThingPlusESP32WROOMUSBCProps = Omit<
  ChipProps<typeof SparkFunThingPlusESP32WROOMUSBC_PIN_LABELS>,
  FixedProps
>;

export const SparkFunThingPlusESP32WROOMUSBC = (
  props: SparkFunThingPlusESP32WROOMUSBCProps,
) => (
  <chip
    {...props}
