...
export const ADAFRUIT_FEATHER_M4_EXPRESS_FOOTPRINT =
  "pinrow28_rows2_cols16_p2.54mm_py20.32mm_missing(1,2,3,4)_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(FEATHER M4)" as const
...
export const ADAFRUIT_FEATHER_M4_EXPRESS_PIN_ATTRIBUTES = {
...
export type AdafruitFeatherM4ExpressProps = Omit<
  ChipProps<typeof ADAFRUIT_FEATHER_M4_EXPRESS_PIN_LABELS>,
  FixedProps
>

export const AdafruitFeatherM4Express = (
  props: AdafruitFeatherM4ExpressProps,
) => (
  <chip
    {...props}
    displayName="Adafruit Feather M4 Express"
    mfn="Adafruit"
    manufacturerPartNumber="3857"
