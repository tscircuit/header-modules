...
export const PololuDRV8834LowVoltageStepperDriverCarrier_FOOTPRINT =
  "headermodule16_rows2_p2.54mm_py12.7mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(Pololu DRV8834 Low-Voltage Ste)" as const;

export const PololuDRV8834LowVoltageStepperDriverCarrier_PIN_LABELS = {
  pin1: ["ENABLE"],
  pin2: ["VMOT"],
  pin3: ["GND_MOTOR"],
  pin4: ["2B"],
...
export const PololuDRV8834LowVoltageStepperDriverCarrier_PIN_ATTRIBUTES = {
...
export type PololuDRV8834LowVoltageStepperDriverCarrierProps = Omit<
  ChipProps<typeof PololuDRV8834LowVoltageStepperDriverCarrier_PIN_LABELS>,
  FixedProps
>;

export const PololuDRV8834LowVoltageStepperDriverCarrier = (
  props: PololuDRV8834LowVoltageStepperDriverCarrierProps,
) => (
  <chip
    {...props}
