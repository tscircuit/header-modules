...
export const LOLIND1MiniV4_FOOTPRINT =
  "headermodule30_rows2_p2.54mm_py15.24mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(LOLIN D1 v4)" as const;

export const LOLIND1MiniV4_PIN_LABELS = {
  pin1: ["3V3"],
  pin2: ["GND"],
  pin3: ["EN"],
  pin4: ["VP"],
...
export const LOLIND1MiniV4_PIN_ATTRIBUTES = {
  "3V3": {
    providesPower: true,
...
export type LOLIND1MiniV4Props = Omit<
  ChipProps<typeof LOLIND1MiniV4_PIN_LABELS>,
  FixedProps
>;
