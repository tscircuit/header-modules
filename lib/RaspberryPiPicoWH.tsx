...
/** Raspberry Pi Pico WH: the 40-pin headered Pico-series interface. */
export const RASPBERRY_PI_PICO_WH_FOOTPRINT =
  "headermodule40_rows2_p2.54mm_py17.78mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(PICO WH)" as const

export const RASPBERRY_PI_PICO_WH_PIN_LABELS = {
  pin1: ["GP0", "GPIO0", "D0"],
  pin2: ["VBUS", "5V", "USB_5V"],
  pin3: ["VSYS", "SYS"],
  pin4: ["GND7", "GND"],
...
export const RASPBERRY_PI_PICO_WH_PIN_ATTRIBUTES = {
  GP0: GPIO,
  GP1: GPIO,
  GND1: GROUND,
  GP2: GPIO,
...
export type RaspberryPiPicoWHProps = Omit<
  ChipProps<typeof RASPBERRY_PI_PICO_WH_PIN_LABELS>,
  FixedProps
>
...
export const RaspberryPiPicoWH = (props: RaspberryPiPicoWHProps) => (
  <chip
    ...
    footprint={RASPBERRY_PI_PICO_WH_FOOTPRINT}
    pinLabels={RASPBERRY_PI_PICO_WH_PIN_LABELS}
    pcbPinLabels={{
      pin1: "GP0",
      pin2: "VBUS",
      pin3: "VSYS",
    ...
    pinAttributes={RASPBERRY_PI_PICO_WH_PIN_ATTRIBUTES}
    schWidth={3.6}
    schHeight={4.2}
    schPinArrangement={{
      leftSide: {
