...
export const PololuDRV8825StepperMotorDriverCarrier_FOOTPRINT =
  "headermodule16_rows2_p2.54mm_py12.7mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(Pololu DRV8825 Stepper Motor)" as const;

export const PololuDRV8825StepperMotorDriverCarrier_PIN_LABELS = {
  pin1: ["ENABLE"],
  pin2: ["VMOT"],
  pin3: ["GND_MOTOR"],
  pin4: ["2B"],
...
export const PololuDRV8825StepperMotorDriverCarrier_PIN_ATTRIBUTES = {
...
export type PololuDRV8825StepperMotorDriverCarrierProps = Omit<
  ChipProps<typeof PololuDRV8825StepperMotorDriverCarrier_PIN_LABELS>,
  FixedProps
>;

export const PololuDRV8825StepperMotorDriverCarrier = (
  props: PololuDRV8825StepperMotorDriverCarrierProps,
) => (
  <chip
    {...props}
