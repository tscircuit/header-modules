...
export const TrinamicTMC5160StepStickModule_FOOTPRINT =
  "headermodule16_rows2_p2.54mm_py12.7mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(Trinamic TMC5160 StepStick)" as const;

export const TrinamicTMC5160StepStickModule_PIN_LABELS = {
  pin1: ["ENABLE"],
  pin2: ["VMOT"],
  pin3: ["GND_MOTOR"],
  pin4: ["2B"],
...
export const TrinamicTMC5160StepStickModule_PIN_ATTRIBUTES = {
...
export type TrinamicTMC5160StepStickModuleProps = Omit<
  ChipProps<typeof TrinamicTMC5160StepStickModule_PIN_LABELS>,
  FixedProps
>;

export const TrinamicTMC5160StepStickModule = (
  props: TrinamicTMC5160StepStickModuleProps,
) => (
  <chip
    {...props}
