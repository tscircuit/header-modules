...
export const GenericLV8729StepperMotorDriverModule_FOOTPRINT =
  "headermodule16_rows2_p2.54mm_py12.7mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(Generic LV8729 Stepper Motor)" as const;

export const GenericLV8729StepperMotorDriverModule_PIN_LABELS = {
  pin1: ["ENABLE"],
  pin2: ["VMOT"],
  pin3: ["GND_MOTOR"],
  pin4: ["2B"],
...
export const GenericLV8729StepperMotorDriverModule_PIN_ATTRIBUTES = {
...
export type GenericLV8729StepperMotorDriverModuleProps = Omit<
  ChipProps<typeof GenericLV8729StepperMotorDriverModule_PIN_LABELS>,
  FixedProps
>;

export const GenericLV8729StepperMotorDriverModule = (
  props: GenericLV8729StepperMotorDriverModuleProps,
) => (
  <chip
    {...props}
