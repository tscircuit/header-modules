...
export const PololuTB67S249FTGStepperMotorDriverCarrier_FOOTPRINT =
  "headermodule16_rows2_p2.54mm_py12.7mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(Pololu TB67S249FTG Stepper Mot)" as const;

export const PololuTB67S249FTGStepperMotorDriverCarrier_PIN_LABELS = {
  pin1: ["ENABLE"],
  pin2: ["VMOT"],
  pin3: ["GND_MOTOR"],
  pin4: ["2B"],
...
export const PololuTB67S249FTGStepperMotorDriverCarrier_PIN_ATTRIBUTES = {
...
export type PololuTB67S249FTGStepperMotorDriverCarrierProps = Omit<
  ChipProps<typeof PololuTB67S249FTGStepperMotorDriverCarrier_PIN_LABELS>,
  FixedProps
>;

export const PololuTB67S249FTGStepperMotorDriverCarrier = (
  props: PololuTB67S249FTGStepperMotorDriverCarrierProps,
) => (
  <chip
    {...props}
