...
export const TrinamicTMC2208StepStickModule_FOOTPRINT =
  "headermodule16_rows2_p2.54mm_py12.7mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(Trinamic TMC2208 StepStick)" as const;

export const TrinamicTMC2208StepStickModule_PIN_LABELS = {
  pin1: ["ENABLE"],
  pin2: ["VMOT"],
  pin3: ["GND_MOTOR"],
  pin4: ["2B"],
...
export const TrinamicTMC2208StepStickModule_PIN_ATTRIBUTES = {
...
export type TrinamicTMC2208StepStickModuleProps = Omit<
  ChipProps<typeof TrinamicTMC2208StepStickModule_PIN_LABELS>,
  FixedProps
>;

export const TrinamicTMC2208StepStickModule = (
  props: TrinamicTMC2208StepStickModuleProps,
) => (
  <chip
    {...props}
