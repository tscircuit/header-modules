...
export const PololuMP6500StepperMotorDriverCarrier_FOOTPRINT =
  "headermodule16_rows2_p2.54mm_py12.7mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(Pololu MP6500 Stepper Motor)" as const;

export const PololuMP6500StepperMotorDriverCarrier_PIN_LABELS = {
  pin1: ["ENABLE"],
  pin2: ["VMOT"],
  pin3: ["GND_MOTOR"],
  pin4: ["2B"],
...
export const PololuMP6500StepperMotorDriverCarrier_PIN_ATTRIBUTES = {
...
export type PololuMP6500StepperMotorDriverCarrierProps = Omit<
  ChipProps<typeof PololuMP6500StepperMotorDriverCarrier_PIN_LABELS>,
  FixedProps
>;

export const PololuMP6500StepperMotorDriverCarrier = (
  props: PololuMP6500StepperMotorDriverCarrierProps,
) => (
  <chip
    {...props}
