...
export const ARDUINO_NANO_33_BLE_PIN_ATTRIBUTES = {
  TX: UART_TX,
  RX: UART_RX,
...
export type ArduinoNano33BLEProps = Omit<
  ChipProps<typeof ARDUINO_NANO_33_BLE_PIN_LABELS>,
  FixedProps
>
...
export const ArduinoNano33BLE = (props: ArduinoNano33BLEProps) => (
  <chip
    ...
    mfn="Arduino"
    manufacturerPartNumber="ABX00030"
    datasheetUrl="https://docs.arduino.cc/resources/pinouts/ABX00030-full-pinout.pdf"
    footprint={ARDUINO_NANO_33_BLE_FOOTPRINT}
    pinLabels={ARDUINO_NANO_33_BLE_PIN_LABELS}
    pcbPinLabels={{
      pin1: "TX",
      pin2: "RX",
      pin3: "RESET",
    ...
    pinAttributes={ARDUINO_NANO_33_BLE_PIN_ATTRIBUTES}
    schWidth={2.1}
    schHeight={3.3}
    schPinArrangement={{
      leftSide: {
