...
export const SparkFunThingPlusRP2350_FOOTPRINT =
  "headermodule28_rows2_cols16_p2.54mm_py20.32mm_missing(1,2,3,4)_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(SparkFun Thing Plus RP2350)" as const;

export const SparkFunThingPlusRP2350_PIN_LABELS = {
  pin1: ["BAT"],
  pin2: ["EN"],
  pin3: ["USB"],
  pin4: ["D13"],
...
export const SparkFunThingPlusRP2350_PIN_ATTRIBUTES = {
...
export type SparkFunThingPlusRP2350Props = Omit<
  ChipProps<typeof SparkFunThingPlusRP2350_PIN_LABELS>,
  FixedProps
>;

export const SparkFunThingPlusRP2350 = (
  props: SparkFunThingPlusRP2350Props,
) => (
  <chip
    {...props}
