...
/** Raspberry Pi Pico 2 with headers: the 40-pin headered Pico-series interface. */
export const RASPBERRY_PI_PICO_2_WITH_HEADERS_FOOTPRINT =
  "headermodule40_rows2_p2.54mm_py17.78mm_id1mm_od1.6mm_female_silkscreenborder_silkscreenlabel(PICO 2)" as const

export const RASPBERRY_PI_PICO_2_WITH_HEADERS_PIN_LABELS = {
  pin1: ["GP0", "GPIO0", "D0"],
  pin2: ["VBUS", "5V", "USB_5V"],
  pin3: ["VSYS", "SYS"],
  pin4: ["GND7", "GND"],
...
export const RASPBERRY_PI_PICO_2_WITH_HEADERS_PIN_ATTRIBUTES = {
  GP0: GPIO,
  GP1: GPIO,
  GND1: GROUND,
  GP2: GPIO,
...
export type RaspberryPiPico2WithHeadersProps = Omit<
  ChipProps<typeof RASPBERRY_PI_PICO_2_WITH_HEADERS_PIN_LABELS>,
  FixedProps
>
...
export const RaspberryPiPico2WithHeaders = (props: RaspberryPiPico2WithHeadersProps) => (
  <chip
    ...
    footprint={RASPBERRY_PI_PICO_2_WITH_HEADERS_FOOTPRINT}
    pinLabels={RASPBERRY_PI_PICO_2_WITH_HEADERS_PIN_LABELS}
    pcbPinLabels={{
      pin1: "GP0",
      pin2: "VBUS",
      pin3: "VSYS",
    ...
    pinAttributes={RASPBERRY_PI_PICO_2_WITH_HEADERS_PIN_ATTRIBUTES}
    schWidth={3.6}
    schHeight={4.2}
    schPinArrangement={{
      leftSide: {
