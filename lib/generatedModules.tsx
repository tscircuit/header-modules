...
type GeneratedPinLabels = Record<string, readonly string[]>
type GeneratedPinAttributes = Record<string, PinAttributeMap>
type GeneratedProps = ChipProps<string>
...
const createHeaderModule = (
  ...
  spec: {
    ...
    pinAttributes: GeneratedPinAttributes
  },
) => (
  <chip
    {...props}
    ...
    pinLabels={spec.pinLabels}
    pinAttributes={spec.pinAttributes}
    schWidth={2.4}
    schHeight={1.8}
  />
)
...
export const AdafruitFeatherESP32S3TFT_FOOTPRINT = FOOTPRINT_F28
export type AdafruitFeatherESP32S3TFTProps = ChipProps<typeof AdafruitFeatherESP32S3TFT_PIN_LABELS>
export const AdafruitFeatherESP32S3TFT = (props: AdafruitFeatherESP32S3TFTProps) =>
  createHeaderModule(props, {
    displayName: "Adafruit Feather ESP32-S3 TFT",
    mfn: "Adafruit",
    footprint: AdafruitFeatherESP32S3TFT_FOOTPRINT,
    pinLabels: AdafruitFeatherESP32S3TFT_PIN_LABELS,
    pinAttributes: AdafruitFeatherESP32S3TFT_PIN_ATTRIBUTES,
  })

/** Adafruit Feather RP2350 — RP2350 Feather-format board. */
export const AdafruitFeatherRP2350_PIN_LABELS = FEATHER28_PIN_LABELS
export const AdafruitFeatherRP2350_PIN_ATTRIBUTES = FEATHER28_PIN_ATTRIBUTES
export const AdafruitFeatherRP2350_FOOTPRINT = FOOTPRINT_F28
export type AdafruitFeatherRP2350Props = ChipProps<typeof AdafruitFeatherRP2350_PIN_LABELS>
export const AdafruitFeatherRP2350 = (props: AdafruitFeatherRP2350Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit Feather RP2350",
    mfn: "Adafruit",
    footprint: AdafruitFeatherRP2350_FOOTPRINT,
    pinLabels: AdafruitFeatherRP2350_PIN_LABELS,
    pinAttributes: AdafruitFeatherRP2350_PIN_ATTRIBUTES,
  })

/** Adafruit ItsyBitsy M0 Express — compact SAMD21 board. */
export const AdafruitItsyBitsyM0Express_PIN_LABELS = ITSYBITSY24_PIN_LABELS
export const AdafruitItsyBitsyM0Express_PIN_ATTRIBUTES = ITSYBITSY24_PIN_ATTRIBUTES
export const AdafruitItsyBitsyM0Express_FOOTPRINT = FOOTPRINT_F24
export type AdafruitItsyBitsyM0ExpressProps = ChipProps<typeof AdafruitItsyBitsyM0Express_PIN_LABELS>
export const AdafruitItsyBitsyM0Express = (props: AdafruitItsyBitsyM0ExpressProps) =>
  createHeaderModule(props, {
    displayName: "Adafruit ItsyBitsy M0 Express",
    mfn: "Adafruit",
    footprint: AdafruitItsyBitsyM0Express_FOOTPRINT,
    pinLabels: AdafruitItsyBitsyM0Express_PIN_LABELS,
    pinAttributes: AdafruitItsyBitsyM0Express_PIN_ATTRIBUTES,
  })

/** Adafruit ItsyBitsy M4 Express — compact SAMD51 board. */
export const AdafruitItsyBitsyM4Express_PIN_LABELS = ITSYBITSY24_PIN_LABELS
export const AdafruitItsyBitsyM4Express_PIN_ATTRIBUTES = ITSYBITSY24_PIN_ATTRIBUTES
export const AdafruitItsyBitsyM4Express_FOOTPRINT = FOOTPRINT_F24
export type AdafruitItsyBitsyM4ExpressProps = ChipProps<typeof AdafruitItsyBitsyM4Express_PIN_LABELS>
export const AdafruitItsyBitsyM4Express = (props: AdafruitItsyBitsyM4ExpressProps) =>
  createHeaderModule(props, {
    displayName: "Adafruit ItsyBitsy M4 Express",
    mfn: "Adafruit",
    footprint: AdafruitItsyBitsyM4Express_FOOTPRINT,
    pinLabels: AdafruitItsyBitsyM4Express_PIN_LABELS,
    pinAttributes: AdafruitItsyBitsyM4Express_PIN_ATTRIBUTES,
  })

/** Adafruit ItsyBitsy nRF52840 Express — compact Bluetooth board. */
export const AdafruitItsyBitsyNRF52840Express_PIN_LABELS = ITSYBITSY24_PIN_LABELS
export const AdafruitItsyBitsyNRF52840Express_PIN_ATTRIBUTES = ITSYBITSY24_PIN_ATTRIBUTES
export const AdafruitItsyBitsyNRF52840Express_FOOTPRINT = FOOTPRINT_F24
export type AdafruitItsyBitsyNRF52840ExpressProps = ChipProps<typeof AdafruitItsyBitsyNRF52840Express_PIN_LABELS>
export const AdafruitItsyBitsyNRF52840Express = (props: AdafruitItsyBitsyNRF52840ExpressProps) =>
  createHeaderModule(props, {
    displayName: "Adafruit ItsyBitsy nRF52840 Express",
    mfn: "Adafruit",
    footprint: AdafruitItsyBitsyNRF52840Express_FOOTPRINT,
    pinLabels: AdafruitItsyBitsyNRF52840Express_PIN_LABELS,
    pinAttributes: AdafruitItsyBitsyNRF52840Express_PIN_ATTRIBUTES,
  })

/** Adafruit ItsyBitsy RP2040 — compact RP2040 board. */
export const AdafruitItsyBitsyRP2040_PIN_LABELS = ITSYBITSY24_PIN_LABELS
export const AdafruitItsyBitsyRP2040_PIN_ATTRIBUTES = ITSYBITSY24_PIN_ATTRIBUTES
export const AdafruitItsyBitsyRP2040_FOOTPRINT = FOOTPRINT_F24
export type AdafruitItsyBitsyRP2040Props = ChipProps<typeof AdafruitItsyBitsyRP2040_PIN_LABELS>
export const AdafruitItsyBitsyRP2040 = (props: AdafruitItsyBitsyRP2040Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit ItsyBitsy RP2040",
    mfn: "Adafruit",
    footprint: AdafruitItsyBitsyRP2040_FOOTPRINT,
    pinLabels: AdafruitItsyBitsyRP2040_PIN_LABELS,
    pinAttributes: AdafruitItsyBitsyRP2040_PIN_ATTRIBUTES,
  })

/** Adafruit ItsyBitsy ESP32 — compact ESP32 board. */
export const AdafruitItsyBitsyESP32_PIN_LABELS = ITSYBITSY24_PIN_LABELS
export const AdafruitItsyBitsyESP32_PIN_ATTRIBUTES = ITSYBITSY24_PIN_ATTRIBUTES
export const AdafruitItsyBitsyESP32_FOOTPRINT = FOOTPRINT_F24
export type AdafruitItsyBitsyESP32Props = ChipProps<typeof AdafruitItsyBitsyESP32_PIN_LABELS>
export const AdafruitItsyBitsyESP32 = (props: AdafruitItsyBitsyESP32Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit ItsyBitsy ESP32",
    mfn: "Adafruit",
    footprint: AdafruitItsyBitsyESP32_FOOTPRINT,
    pinLabels: AdafruitItsyBitsyESP32_PIN_LABELS,
    pinAttributes: AdafruitItsyBitsyESP32_PIN_ATTRIBUTES,
  })

/** Adafruit QT Py SAMD21 — tiny castellated/0.1 in header-ready board. */
export const AdafruitQTPySAMD21_PIN_LABELS = QTPY12_PIN_LABELS
export const AdafruitQTPySAMD21_PIN_ATTRIBUTES = QTPY12_PIN_ATTRIBUTES
export const AdafruitQTPySAMD21_FOOTPRINT = FOOTPRINT_F12
export type AdafruitQTPySAMD21Props = ChipProps<typeof AdafruitQTPySAMD21_PIN_LABELS>
export const AdafruitQTPySAMD21 = (props: AdafruitQTPySAMD21Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit QT Py SAMD21",
    mfn: "Adafruit",
    footprint: AdafruitQTPySAMD21_FOOTPRINT,
    pinLabels: AdafruitQTPySAMD21_PIN_LABELS,
    pinAttributes: AdafruitQTPySAMD21_PIN_ATTRIBUTES,
  })

/** Adafruit QT Py ESP32-S2 — tiny castellated/0.1 in header-ready board. */
export const AdafruitQTPyESP32S2_PIN_LABELS = QTPY12_PIN_LABELS
export const AdafruitQTPyESP32S2_PIN_ATTRIBUTES = QTPY12_PIN_ATTRIBUTES
export const AdafruitQTPyESP32S2_FOOTPRINT = FOOTPRINT_F12
export type AdafruitQTPyESP32S2Props = ChipProps<typeof AdafruitQTPyESP32S2_PIN_LABELS>
export const AdafruitQTPyESP32S2 = (props: AdafruitQTPyESP32S2Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit QT Py ESP32-S2",
    mfn: "Adafruit",
    footprint: AdafruitQTPyESP32S2_FOOTPRINT,
    pinLabels: AdafruitQTPyESP32S2_PIN_LABELS,
    pinAttributes: AdafruitQTPyESP32S2_PIN_ATTRIBUTES,
  })

/** Adafruit QT Py ESP32-S3 — tiny castellated/0.1 in header-ready board. */
export const AdafruitQTPyESP32S3_PIN_LABELS = QTPY12_PIN_LABELS
export const AdafruitQTPyESP32S3_PIN_ATTRIBUTES = QTPY12_PIN_ATTRIBUTES
export const AdafruitQTPyESP32S3_FOOTPRINT = FOOTPRINT_F12
export type AdafruitQTPyESP32S3Props = ChipProps<typeof AdafruitQTPyESP32S3_PIN_LABELS>
export const AdafruitQTPyESP32S3 = (props: AdafruitQTPyESP32S3Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit QT Py ESP32-S3",
    mfn: "Adafruit",
    footprint: AdafruitQTPyESP32S3_FOOTPRINT,
    pinLabels: AdafruitQTPyESP32S3_PIN_LABELS,
    pinAttributes: AdafruitQTPyESP32S3_PIN_ATTRIBUTES,
  })

/** Adafruit QT Py nRF52840 — tiny castellated/0.1 in header-ready board. */
export const AdafruitQTPyNRF52840_PIN_LABELS = QTPY12_PIN_LABELS
export const AdafruitQTPyNRF52840_PIN_ATTRIBUTES = QTPY12_PIN_ATTRIBUTES
export const AdafruitQTPyNRF52840_FOOTPRINT = FOOTPRINT_F12
export type AdafruitQTPyNRF52840Props = ChipProps<typeof AdafruitQTPyNRF52840_PIN_LABELS>
export const AdafruitQTPyNRF52840 = (props: AdafruitQTPyNRF52840Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit QT Py nRF52840",
    mfn: "Adafruit",
    footprint: AdafruitQTPyNRF52840_FOOTPRINT,
    pinLabels: AdafruitQTPyNRF52840_PIN_LABELS,
    pinAttributes: AdafruitQTPyNRF52840_PIN_ATTRIBUTES,
  })

/** Adafruit QT Py RP2350 — tiny castellated/0.1 in header-ready board. */
export const AdafruitQTPyRP2350_PIN_LABELS = QTPY12_PIN_LABELS
export const AdafruitQTPyRP2350_PIN_ATTRIBUTES = QTPY12_PIN_ATTRIBUTES
export const AdafruitQTPyRP2350_FOOTPRINT = FOOTPRINT_F12
export type AdafruitQTPyRP2350Props = ChipProps<typeof AdafruitQTPyRP2350_PIN_LABELS>
export const AdafruitQTPyRP2350 = (props: AdafruitQTPyRP2350Props) =>
  createHeaderModule(props, {
    displayName: "Adafruit QT Py RP2350",
    mfn: "Adafruit",
    footprint: AdafruitQTPyRP2350_FOOTPRINT,
    pinLabels: AdafruitQTPyRP2350_PIN_LABELS,
    pinAttributes: AdafruitQTPyRP2350_PIN_ATTRIBUTES,
  })

/** Arduino Nano ATmega328P — classic Nano dual-row module. */
export const ArduinoNanoATmega328P_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNanoATmega328P_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNanoATmega328P_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNanoATmega328PProps = ChipProps<typeof ArduinoNanoATmega328P_PIN_LABELS>
export const ArduinoNanoATmega328P = (props: ArduinoNanoATmega328PProps) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano ATmega328P",
    mfn: "Arduino",
    footprint: ArduinoNanoATmega328P_FOOTPRINT,
    pinLabels: ArduinoNanoATmega328P_PIN_LABELS,
    pinAttributes: ArduinoNanoATmega328P_PIN_ATTRIBUTES,
  })

/** Arduino Nano Every — ATmega4809 Nano module. */
export const ArduinoNanoEvery_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNanoEvery_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNanoEvery_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNanoEveryProps = ChipProps<typeof ArduinoNanoEvery_PIN_LABELS>
export const ArduinoNanoEvery = (props: ArduinoNanoEveryProps) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano Every",
    mfn: "Arduino",
    footprint: ArduinoNanoEvery_FOOTPRINT,
    pinLabels: ArduinoNanoEvery_PIN_LABELS,
    pinAttributes: ArduinoNanoEvery_PIN_ATTRIBUTES,
  })

/** Arduino Nano 33 IoT — SAMD21 + wireless Nano module. */
export const ArduinoNano33IoT_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNano33IoT_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNano33IoT_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNano33IoTProps = ChipProps<typeof ArduinoNano33IoT_PIN_LABELS>
export const ArduinoNano33IoT = (props: ArduinoNano33IoTProps) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano 33 IoT",
    mfn: "Arduino",
    footprint: ArduinoNano33IoT_FOOTPRINT,
    pinLabels: ArduinoNano33IoT_PIN_LABELS,
    pinAttributes: ArduinoNano33IoT_PIN_ATTRIBUTES,
  })

/** Arduino Nano 33 BLE — nRF52840 Nano module. */
export const ArduinoNano33BLE_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNano33BLE_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNano33BLE_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNano33BLEProps = ChipProps<typeof ArduinoNano33BLE_PIN_LABELS>
export const ArduinoNano33BLE = (props: ArduinoNano33BLEProps) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano 33 BLE",
    mfn: "Arduino",
    footprint: ArduinoNano33BLE_FOOTPRINT,
    pinLabels: ArduinoNano33BLE_PIN_LABELS,
    pinAttributes: ArduinoNano33BLE_PIN_ATTRIBUTES,
  })

/** Arduino Nano 33 BLE Sense Rev2 — sensor-rich nRF52840 Nano module. */
export const ArduinoNano33BLESenseRev2_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNano33BLESenseRev2_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNano33BLESenseRev2_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNano33BLESenseRev2Props = ChipProps<typeof ArduinoNano33BLESenseRev2_PIN_LABELS>
export const ArduinoNano33BLESenseRev2 = (props: ArduinoNano33BLESenseRev2Props) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano 33 BLE Sense Rev2",
    mfn: "Arduino",
    footprint: ArduinoNano33BLESenseRev2_FOOTPRINT,
    pinLabels: ArduinoNano33BLESenseRev2_PIN_LABELS,
    pinAttributes: ArduinoNano33BLESenseRev2_PIN_ATTRIBUTES,
  })

/** Arduino Nano ESP32 — ESP32-S3 Nano module. */
export const ArduinoNanoESP32_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNanoESP32_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNanoESP32_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNanoESP32Props = ChipProps<typeof ArduinoNanoESP32_PIN_LABELS>
export const ArduinoNanoESP32 = (props: ArduinoNanoESP32Props) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano ESP32",
    mfn: "Arduino",
    footprint: ArduinoNanoESP32_FOOTPRINT,
    pinLabels: ArduinoNanoESP32_PIN_LABELS,
    pinAttributes: ArduinoNanoESP32_PIN_ATTRIBUTES,
  })

/** Arduino Nano RP2040 Connect — RP2040 + wireless Nano module. */
export const ArduinoNanoRP2040Connect_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNanoRP2040Connect_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNanoRP2040Connect_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNanoRP2040ConnectProps = ChipProps<typeof ArduinoNanoRP2040Connect_PIN_LABELS>
export const ArduinoNanoRP2040Connect = (props: ArduinoNanoRP2040ConnectProps) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano RP2040 Connect",
    mfn: "Arduino",
    footprint: ArduinoNanoRP2040Connect_FOOTPRINT,
    pinLabels: ArduinoNanoRP2040Connect_PIN_LABELS,
    pinAttributes: ArduinoNanoRP2040Connect_PIN_ATTRIBUTES,
  })

/** Arduino Nano Matter — MGM240S Matter/Thread Nano module. */
export const ArduinoNanoMatter_PIN_LABELS = NANO30_PIN_LABELS
export const ArduinoNanoMatter_PIN_ATTRIBUTES = NANO30_PIN_ATTRIBUTES
export const ArduinoNanoMatter_FOOTPRINT = FOOTPRINT_F30
export type ArduinoNanoMatterProps = ChipProps<typeof ArduinoNanoMatter_PIN_LABELS>
export const ArduinoNanoMatter = (props: ArduinoNanoMatterProps) =>
  createHeaderModule(props, {
    displayName: "Arduino Nano Matter",
    mfn: "Arduino",
    footprint: ArduinoNanoMatter_FOOTPRINT,
    pinLabels: ArduinoNanoMatter_PIN_LABELS,
    pinAttributes: ArduinoNanoMatter_PIN_ATTRIBUTES,
  })
