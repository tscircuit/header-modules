...
export const ARDUINO_NANO_33_IOT_PIN_ATTRIBUTES = {
  TX: UART_TX,
  RX: UART_RX,
...
export type ArduinoNano33IoTProps = Omit<
  ChipProps<typeof ARDUINO_NANO_33_IOT_PIN_LABELS>,
  FixedProps
>
...
export const ArduinoNano33IoT = (props: ArduinoNano33IoTProps) => (
  <chip
    ...
    mfn="Arduino"
    manufacturerPartNumber="ABX00027"
